    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-B5CXIV2C.js"), import("./pbr.fragment-HKXHUEXA.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-EAVXOVPT.js"), import("./pbr.fragment-X4KCVXMG.js")]);
        }
...
//# sourceMappingURL=chunk-EG5ZX37V.js.map
