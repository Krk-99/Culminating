...
var LazyAnimationGroupModulePromise = new Lazy(() => import("./animationGroup-OQYSYZEY.js"));
var LazyLoaderAnimationModulePromise = new Lazy(() => import("./glTFLoaderAnimation-6YKWMVLN.js"));
var ArrayItem = class {
  /**
      ...
      if (!this.parent.skipMaterials && this._pbrMaterialImpl == null) {
        if (this.parent.useOpenPBR || this.isExtensionUsed("KHR_materials_openpbr")) {
          this._pbrMaterialImpl = {
            materialClass: (await import("./openpbrMaterial-LNAWEQUV.js")).OpenPBRMaterial,
            adapterClass: (await import("./openpbrMaterialLoadingAdapter-C66PPU7I.js")).OpenPBRMaterialLoadingAdapter
          };
        } else {
          this._pbrMaterialImpl = {
            materialClass: (await import("./pbrMaterial-7D6OD5OO.js")).PBRMaterial,
...
//# sourceMappingURL=chunk-74C4OGAW.js.map
