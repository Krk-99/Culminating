    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-IZYATO7U.js"), import("./openpbr.fragment-LF4LVAMD.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-VETPZGLG.js"), import("./openpbr.fragment-HNHIF3KP.js")]);
        }
...
//# sourceMappingURL=chunk-7M57A6NX.js.map
