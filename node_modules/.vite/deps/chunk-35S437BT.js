    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./openpbr.vertex-5M3EOMTO.js"), import("./openpbr.fragment-4X2YZA37.js")]);
        } else {
          await Promise.all([import("./openpbr.vertex-BPNAJCGI.js"), import("./openpbr.fragment-27SCT62W.js")]);
        }
...
//# sourceMappingURL=chunk-35S437BT.js.map
