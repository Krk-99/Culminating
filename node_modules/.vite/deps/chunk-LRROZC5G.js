    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-SGE6E7HY.js"), import("./pbr.fragment-I37IYG4C.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-EYLHSTX4.js"), import("./pbr.fragment-KXGIJAK5.js")]);
        }
...
//# sourceMappingURL=chunk-LRROZC5G.js.map
